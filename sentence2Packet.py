...
gen *.prebuild by executing sentence2Prebuild.py ,then execute /home/ferrero/cloudinn/builds_to_packet.py to get *.packet file...
*.prebuild and *.packet both the same dir with original sentence
'''
import os
import sys
import subprocess
